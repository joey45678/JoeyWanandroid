...
package com.example.joeywanandroid.ui.views.widget;
...
public class MSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private View mContentView; // the target of the gesture
    ...
    protected void onAttachedToWindow() {
        ...
        super.bringChildToFront(mLoadingView);
    }
    ...
    private void ensureTarget() {
        ...
        if (mContentView == null) {
            for (int i = 0; i < getChildCount(); i++) {
                ...
                if (!child.equals(mLoadingView)&&!child.equals(mCircleView)) {
                    mContentView = child;
                    break;
                }
            }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        mLoadingView.layout((width/2-loadingWidth/2),height,(width/2+loadingWidth/2),height+loadingHeight);
        mContentView.setTranslationY(loadingHeight);
        mLoadingView.setTranslationY(-loadingHeight);
    }
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(@NonNull MSwipeRefreshLayout parent, @Nullable View child);
    }
}
